...
public class UserStoryEntity implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (bussinessValue != that.bussinessValue)
			return false;
		if (id != that.id)
			return false;
		if (estimatedTime != null ? !estimatedTime.equals(that.estimatedTime)
				: that.estimatedTime != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (estimatedTime != null ? estimatedTime.hashCode() : 0);
		return result;
	}
	...
	public void setAcceptenceTests(
			Collection<AcceptenceTestEntity> acceptenceTests) {
